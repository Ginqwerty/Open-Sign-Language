...
- **[CVPR]** LLMs Are Good Sign Language Translators (LLM-SLT) [Paper](https://openaccess.thecvf.com/content/CVPR2024/html/Gong_LLMs_are_Good_Sign_Language_Translators_CVPR_2024_paper.html) <<span style="background-color: #f0f0f0; padding: 3px 5px; border-radius: 3px; box-shadow: 2px 2px 5px rgba(0, 0, 0, 0.2);">需要高亮的文字</span>
