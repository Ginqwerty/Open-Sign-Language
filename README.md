...
|[UNI-SIGN](https://iclr.cc/virtual/2025/poster/31250)          |2025  |26.0       |  RTMPose-x + Spatial-GCN + ST-GCN + EfficientNet-B0 + Prior-Guided Fusion (Multi-head + Deformable Attention + Gate) + mT5-Base + Unified LM Loss (no CTC)   | ICLR          |[Avaliable](https://github.com/ZechengLi19/Uni-Sign)        |
